    ...
    <div className="w-full overflow-x-auto py-2">
      <div className="flex space-x-3 py-3">
        {mainColors.map((color) => (
          <div key={color.name} className="flex-shrink-0 flex flex-col items-center">
            <div
              className="w-10 h-10 rounded-full shadow-md cursor-pointer hover:scale-125 transition-transform border-2 border-white/10"
